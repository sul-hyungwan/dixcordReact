...
function Register(props) {
    ...
    useEffect( () => {
        if((registerUser.userEmail, registerUser.userPassword, registerUser.userName, registerUser.userBirthday) !== null && checkbox === true){
            ...
            <InputArea style={{display : inputOnOff}}>
                <RegisterDiv>
                    ...
                    <UserInputSection>
                        ...
                        <input type="text" name="userName" value={registerUser.userName} onChange={handleOnchagneInput}/>
                    </UserInputSection>
                    ...
                    <UserCheckSection>
                        <input type="checkbox" name="checkdAll" onChange={handleChecked}/>
                        <p>개인 정보 동의 <RedStarSpan id='checkboxCheck'>*</RedStarSpan></p>
                    </UserCheckSection>
                </RegisterDiv>
                <BtnDiv>
                    <BtnSection>
                        <button onClick={handleClickJoin}>계속하기</button>
                    </BtnSection>
                    <LinkSection>
